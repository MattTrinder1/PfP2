...
{
    [TestClass]
    public class PocketNotebookTests
    {
        ...
        [TestMethod]
        public async Task CreatePNBWithSketch()
        {
            var client = StartUp.GetClient();
        ...
        [TestMethod]
        public async Task CreatePNBWithPhoto()
        {
            var client = StartUp.GetClient();
        ...
        [TestMethod]
        public async Task CreatePNBWithIncident()
        {
            var client = StartUp.GetClient();
        ...
        [TestMethod]
        public async Task CreatePNBNoDates()
        {
            var client = StartUp.GetClient();
        ...
        [TestMethod]
        public async Task GetPNBListView()
        {
            var client = StartUp.GetClient();
        ...
        private bool DateTimesMatch(DateTime? expected, DateTime? actual)
        {
